package org.minnal.dropwizard.examples.petclinic.domain.generated;
 ...
 */
public class OwnerResourceTest extends
		org.minnal.dropwizard.test.BaseDropwizardResourceTest {
	@Test
	public void listOwnerTest() {
		org.minnal.dropwizard.examples.petclinic.domain.Owner owner = createDomain(org.minnal.dropwizard.examples.petclinic.domain.Owner.class);
		owner.persist();
		...
		assertEquals(deserializeCollection(
				...
				org.minnal.dropwizard.examples.petclinic.domain.Owner.class)
				.size(),
				(int) org.minnal.dropwizard.examples.petclinic.domain.Owner
						.count());
	}
	...
	public void updateOwnerTest() {
		org.minnal.dropwizard.examples.petclinic.domain.Owner owner = createDomain(org.minnal.dropwizard.examples.petclinic.domain.Owner.class);
		owner.persist();
		org.minnal.dropwizard.examples.petclinic.domain.Owner modifiedowner = createDomain(
				org.minnal.dropwizard.examples.petclinic.domain.Owner.class,
				1);
		ContainerResponse response = call(request(
	...
	public void listOwnerPetTest() {
		...
		org.minnal.dropwizard.examples.petclinic.domain.Pet pet = createDomain(org.minnal.dropwizard.examples.petclinic.domain.Pet.class);
		...
		assertEquals(deserializeCollection(
				getContent(response),
				java.util.List.class,
				org.minnal.dropwizard.examples.petclinic.domain.Pet.class)
	...
	public void updateOwnerPetTest() {
		...
		owner.collection("pets").add(pet);
		owner.persist();
		org.minnal.dropwizard.examples.petclinic.domain.Pet modifiedpet = createDomain(
				org.minnal.dropwizard.examples.petclinic.domain.Pet.class,
				1);
		ContainerResponse response = call(request(
				"/owners/" + owner.getId() + "/pets/"
	...
	public void listOwnerPetVisitTest() {
		...
		org.minnal.dropwizard.examples.petclinic.domain.Visit visit = createDomain(org.minnal.dropwizard.examples.petclinic.domain.Visit.class);
		...
		assertEquals(deserializeCollection(
				getContent(response),
				java.util.List.class,
				org.minnal.dropwizard.examples.petclinic.domain.Visit.class)
	...
	public void updateOwnerPetVisitTest() {
		...
		pet.collection("visits").add(visit);
		pet.persist();
		org.minnal.dropwizard.examples.petclinic.domain.Visit modifiedvisit = createDomain(
				org.minnal.dropwizard.examples.petclinic.domain.Visit.class,
				1);
		ContainerResponse response = call(request(
				"/owners/" + owner.getId() + "/pets/"
