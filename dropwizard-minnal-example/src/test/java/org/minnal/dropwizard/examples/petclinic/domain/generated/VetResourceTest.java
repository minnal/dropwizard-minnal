 ...
 */
public class VetResourceTest extends
		org.minnal.dropwizard.test.BaseDropwizardResourceTest {
	@Test
	public void listVetTest() {
		org.minnal.dropwizard.examples.petclinic.domain.Vet vet = createDomain(org.minnal.dropwizard.examples.petclinic.domain.Vet.class);
		vet.persist();
		...
		assertEquals(deserializeCollection(
				...
				org.minnal.dropwizard.examples.petclinic.domain.Vet.class)
				.size(),
				(int) org.minnal.dropwizard.examples.petclinic.domain.Vet
						.count());
	}
	...
	public void updateVetTest() {
		org.minnal.dropwizard.examples.petclinic.domain.Vet vet = createDomain(org.minnal.dropwizard.examples.petclinic.domain.Vet.class);
		vet.persist();
		org.minnal.dropwizard.examples.petclinic.domain.Vet modifiedvet = createDomain(
				org.minnal.dropwizard.examples.petclinic.domain.Vet.class,
				1);
		ContainerResponse response = call(request(
	...
	public void listVetSpecialtyTest() {
		...
		org.minnal.dropwizard.examples.petclinic.domain.Specialty specialty = createDomain(org.minnal.dropwizard.examples.petclinic.domain.Specialty.class);
		...
		assertEquals(deserializeCollection(
				getContent(response),
				java.util.List.class,
				org.minnal.dropwizard.examples.petclinic.domain.Specialty.class)
	...
	public void updateVetSpecialtyTest() {
		...
		vet.collection("specialties").add(specialty);
		vet.persist();
		org.minnal.dropwizard.examples.petclinic.domain.Specialty modifiedspecialty = createDomain(
				org.minnal.dropwizard.examples.petclinic.domain.Specialty.class,
				1);
		ContainerResponse response = call(request(
				"/vets/" + vet.getId() + "/specialties/"
