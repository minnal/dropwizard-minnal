 ...
 */
public class PetTypeResourceTest extends
		org.minnal.dropwizard.test.BaseDropwizardResourceTest {
	@Test
	public void listPetTypeTest() {
		org.minnal.dropwizard.examples.petclinic.domain.PetType petType = createDomain(org.minnal.dropwizard.examples.petclinic.domain.PetType.class);
		petType.persist();
		...
		assertEquals(deserializeCollection(
				...
				org.minnal.dropwizard.examples.petclinic.domain.PetType.class)
				.size(),
				(int) org.minnal.dropwizard.examples.petclinic.domain.PetType
						.count());
	}
	...
	public void updatePetTypeTest() {
		org.minnal.dropwizard.examples.petclinic.domain.PetType petType = createDomain(org.minnal.dropwizard.examples.petclinic.domain.PetType.class);
		petType.persist();
		org.minnal.dropwizard.examples.petclinic.domain.PetType modifiedpetType = createDomain(
				org.minnal.dropwizard.examples.petclinic.domain.PetType.class,
				1);
		ContainerResponse response = call(request("/pet_types/"
